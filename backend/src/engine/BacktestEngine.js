...
function runBacktest(priceHistory, { entryIndex = 0, direction = 'up', stake = 100, multiplier = 1 } = {}) {
...
function findOptimalEntry(priceHistory, direction = 'up') {
...
module.exports = { runBacktest, findOptimalEntry };
