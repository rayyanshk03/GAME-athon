...
function computeHybridScore(voteData, aiSentiment = 0) {
...
function resolveContest(room, currentPrices) {
...
function getSimModeConfig(mode) {
  return {
...
module.exports = { computeHybridScore, resolveContest, getSimModeConfig };
