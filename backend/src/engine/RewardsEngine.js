...
function checkDailyLogin(lastLoginTs) {
  const dayMs = 864e5;
...
function checkBadgeUnlocks(stats, currentBadgeIds = []) {
...
function updateQuestProgress(quests, eventType, value = 1) {
  return quests.map(q => {
...
module.exports = { BADGES, checkDailyLogin, getStreakBonus, checkBadgeUnlocks, generateDailyQuests, updateQuestProgress };
